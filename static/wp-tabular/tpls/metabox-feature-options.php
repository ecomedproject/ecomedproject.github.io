   ...
   $fkeys=@array_keys($feature_name);
    ...
    foreach($feature_name as $index1=> $value1){
        ...
        foreach($package_name as $index=> $value){
            ...
            echo  '<td class="'.$index.' '.$index1.'"><textarea  id="features['.$index.']['.$index1.']" name="features['.$index.']['.$index1.']">'
            .$data[$index][$index1].' </textarea>
      ...
      jQuery('#addrow').click(function(){
          ...
          $ftr_info = "<span id='sf"+tmp_fid+"'>"+feat+"</span><input type=hidden name='feature_name["+tmp_fid+"]' value='"+feat+"'/>"; 
           ...
           jQuery("#pricetable tbody tr:last").find("td").each(function() {
               ...
               ht= jQuery(this).find('textarea').attr('name');
               ht=new String(ht); 
               if(ht != "undefined"){
                   var pos= ht.indexOf("]");  
                   ...
                   var nnam=cnam+"["+tmp_fid+"]";
                    //alert(nnam);
                   jQuery(this).find('textarea').attr("name",nnam);
                   jQuery(this).find('textarea').attr("id",nnam);
                   //alert(nnam);
               } 
              ...
              */
              ...
              jQuery("#pricetable").find("tr").each(function() {
               ...
               if(trim(jQuery(this).find('td:first').html())!="Packages/Features"){                          
                    jQuery(this).find('td:last').append('<textarea id="'+cid+'" name="'+htm+'"  ></textarea>');                   
